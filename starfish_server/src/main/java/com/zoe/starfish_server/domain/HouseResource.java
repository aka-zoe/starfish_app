...
public class HouseResource {
    ...
    public Long getHouseImageId() {
        return houseImageId;
    }

    public void setHouseImageId(Long houseImageId) {
    ...
    public Integer getTableChair() {
        return tableChair;
    }

    public void setTableChair(Integer tableChair) {
    ...
    public String toString() {
        ...
        sb.append(", tableChair=").append(tableChair);
        sb.append(", tv=").append(tv);
        sb.append(", waterHeater=").append(waterHeater);
        ...
        sb.append(", publisherNumber=").append(publisherNumber);
        sb.append(", tagId=").append(tagId);
        sb.append(", publisherId=").append(publisherId);
        sb.append(", publisherType=").append(publisherType);
        sb.append(", publisherHead=").append(publisherHead);
